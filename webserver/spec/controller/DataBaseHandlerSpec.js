...
describe("Write query for ", function () {
  ...
  it("create database.", function () {
    ...
    expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
...
describe("Accessing the mastertable successfully ", function () {
  ...
  it("should allow to get all mac addresses.", function () {
    uut.getAllMacAddresses(function (error, result) {
      expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
        "SELECT mac,name FROM master_data_base.master_table",
        jasmine.any(Function)
      );
  ...
  it("should allow to get all names for the mac addresses.", function () {
    uut.getAllNamesForTheMacAddress(function (error, result) {
      expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
        "SELECT name FROM master_data_base.master_table",
        jasmine.any(Function)
      );
      expect(error).toBe(null);
      expect(result).toBe(true);
...
describe("Accessing the mastertable not successfully ", function () {
  ...
  it("should handle the erro when trying to get all mac addresses.", function () {
    uut.getAllMacAddresses(function (error, result) {
      expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
        "SELECT mac,name FROM master_data_base.master_table",
        jasmine.any(Function)
...
describe("Get temperature successfully for ", function () {
  ...
  it("limited number of values from db.", function () {
    ...
    uut.getLimitedNrOfTemperatureValuesFromDB(
      testDataBaseName,
      limit,
      orderBy,
  ...
  it("all values from db.", function () {
    uut.getAllTemperatureValuesFromDB(testDataBaseName, function (
      error,
      result
    ) {
      expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
        "SELECT * FROM " + testDataBaseName + "." + "temperature",
        jasmine.any(Function)
      );
      expect(error).toBe(null);
      expect(result).toBe(true);
  ...
  it("values between two timestamps.", function () {
    ...
    uut.getTemperatureValuesBetweenTimeStampsFromDB(
      testDataBaseName,
      fromTimeStamp,
      toTimeStamp,
      function (error, result) {
        expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
          "SELECT * FROM " +
            testDataBaseName +
            "." +
            "temperature WHERE timestamp BETWEEN '" +
            fromTimeStamp +
            "' AND '" +
            toTimeStamp +
            "'",
...
describe("Get humidity successfully for ", function () {
  ...
  it("limited number of values from db.", function () {
    ...
    uut.getLimitedNrOfHumidityValuesFromDB(
      testDataBaseName,
      limit,
      orderBy,
      function (error, result) {
  ...
  it("all values from db.", function () {
    uut.getAllHumidityValuesFromDB(testDataBaseName, function (error, result) {
      expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
        "SELECT * FROM " + testDataBaseName + "." + "humidity",
        jasmine.any(Function)
      );
      expect(error).toBe(null);
      expect(result).toBe(true);
  ...
  it("values between two timestamps.", function () {
    var fromTimeStamp = "2018-03-17 15:09:49";
    var toTimeStamp = "2018-03-17 15:21:54";
    uut.getHumidityValuesBetweenTimeStampsFromDB(
      testDataBaseName,
      fromTimeStamp,
      toTimeStamp,
      function (error, result) {
        expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
          "SELECT * FROM " +
            testDataBaseName +
            "." +
            "humidity WHERE timestamp BETWEEN '" +
            fromTimeStamp +
            "' AND '" +
            toTimeStamp +
            "'",
...
describe("Get voltage successfully for ", function () {
  ...
  it("limited number of values from db.", function () {
    ...
    uut.getLimitedNrOfVoltageValuesFromDB(
      testDataBaseName,
      limit,
      orderBy,
      function (error, result) {
  ...
  it("all values from db.", function () {
    uut.getAllVoltageValuesFromDB(testDataBaseName, function (error, result) {
      expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
        "SELECT * FROM " + testDataBaseName + "." + "voltage",
        jasmine.any(Function)
      );
      expect(error).toBe(null);
      expect(result).toBe(true);
  ...
  it("values between two timestamps.", function () {
    var fromTimeStamp = "2018-03-17 15:09:49";
    var toTimeStamp = "2018-03-17 15:21:54";
    uut.getVoltageValuesBetweenTimeStampsFromDB(
      testDataBaseName,
      fromTimeStamp,
      toTimeStamp,
      function (error, result) {
        expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
          "SELECT * FROM " +
            testDataBaseName +
            "." +
            "voltage WHERE timestamp BETWEEN '" +
            fromTimeStamp +
            "' AND '" +
            toTimeStamp +
            "'",
...
describe("Value operations ", function () {
  ...
  it("should allow the selecting of a value.", function () {
    ...
    var expectedString =
      ...
      key +
      "'";
    uut.selectValueFromColumnInTable(tableName, key, keyColumnName, function (
      error,
      result
    ) {
      expect(mysqlConnectionFake.query).toHaveBeenCalledWith(
  ...
  it("limited number of values from db.", function () {
    ...
    uut.getLimitedNrOfValuesBasedOnTableNameFromDB(
      testDataBaseName,
      tableName,
      limit,
      orderBy,
...
describe("Get MinAndMaxTimeStamp for mac from DB ", function () {
  ...
  it("Max.", function () {
    var expectedString =
      "SELECT MAX(timestamp) FROM (SELECT timestamp FROM " +
      testDataBaseName +
      ".humidity UNION ALL SELECT timestamp FROM " +
      testDataBaseName +
      ".temperature) as subQuery";
  ...
  it("Min.", function () {
    var expectedString =
      "SELECT MIN(timestamp) FROM (SELECT timestamp FROM " +
      testDataBaseName +
      ".humidity UNION ALL SELECT timestamp FROM " +
      testDataBaseName +
      ".temperature) as subQuery";
